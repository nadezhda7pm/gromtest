...
public class Demo {
    public static void main(String[] args) {
        ...
        User user7 = new User(1, "Kate", "12aaauh");
        User user8 = new User(1, "Kate", "12aaauh");
        User user9 = new User(1, "Katee", "12aaauh");


        System.out.println(user7.equals(user8));
        System.out.println(user7.equals(user9));
        System.out.println(user7.equals(null));
